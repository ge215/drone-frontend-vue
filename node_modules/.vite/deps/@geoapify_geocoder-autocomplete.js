...
var l = class _l {
  ...
  static addFeatureIcon(e2, o2, i2) {
    const a2 = { unknown: "map-marker", amenity: "map-marker", building: "map-marker", street: "road", suburb: "city", district: "city", postcode: "city", city: "city", county: "city", state: "city" }, t2 = d.find((e3) => i2 && e3.code.toLowerCase() === i2.toLowerCase());
    if ("country" === o2 && t2) {
...
var s = class {
  ...
  options = { limit: 5, debounceDelay: 100 };
  ...
  cancelPreviousRequest() {
    this.currentPromiseReject && (this.currentPromiseReject({ canceled: true }), this.currentPromiseReject = null);
  }
  addEventListeners() {
  ...
  cancelPreviousPlaceDetailsRequest() {
    this.currentPlaceDetailsPromiseReject && (this.currentPlaceDetailsPromiseReject({ canceled: true }), this.currentPlaceDetailsPromiseReject = null);
  }
  openDropdownAgain() {
  ...
  constructOptions(e2) {
    this.options = e2 ? { ...this.options, ...e2 } : this.options, this.options.filter = this.options.filter || {}, this.options.bias = this.options.bias || {}, this.options.countryCodes && this.addFilterByCountry(this.options.countryCodes), this.options.position && this.addBiasByProximity(this.options.position);
  }
  addClearButton() {
