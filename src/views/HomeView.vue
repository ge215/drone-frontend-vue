  ...
  <div class="app-layout">
    <aside class="sidebar">
      <div class="sidebar-header">
        <h3><i class="fa-solid fa-helicopter"></i> 無人機系統</h3>
      </div>
      <nav class="sidebar-nav">
        <RouterLink to="/"><i class="fa-solid fa-chart-pie"></i> 儀表板</RouterLink>
        <RouterLink to="/flight-logs"><i class="fa-solid fa-book"></i> 飛行日誌</RouterLink>
        <RouterLink to="/equipment"><i class="fa-solid fa-satellite-dish"></i> 設備管理</RouterLink>
      </nav>
...
.sidebar-header { padding: 1.5rem; text-align: center; font-size: 1.2rem; border-bottom: 1px solid #34495e; }
.sidebar-nav { flex-grow: 1; padding: 1rem 0; }
.sidebar-nav a { display: block; padding: 1rem 1.5rem; color: #bdc3c7; text-decoration: none; transition: background-color 0.2s, color 0.2s; }
